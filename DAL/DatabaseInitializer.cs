    ...
    public class DatabaseInitializer : IDatabaseInitializer
    {
        ...
        public async Task SeedAsync()
        {
            ...
            if (!await _context.Users.AnyAsync())
            {
                ...
                await CreateUserAsync("admin", "Napalm911.", "Inbuilt Administrator", "max@soymkm.com", "+52 (811) 908-6788", new string[] { adminRoleName });
                await CreateUserAsync("user", "Napalm911.", "Inbuilt Standard User", "mario@soymkm.com", "+1 (123) 000-0001", new string[] { userRoleName });
